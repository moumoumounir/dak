...
export class DynamicTableListComponent implements OnInit {
    ...
    @Output() countChanged: EventEmitter<any> =   new EventEmitter();
        ...
        iconActionColumns :any[]= [{ 'key': 'Details', 'icon': 'reorder' }, 
        ...
        getElementValue(element:any,column:string ) {
        ...
        arrayRemove(arr: string[], value: string[]): string[] { 
          return arr.filter((ele: string) => { 
              return !value.includes(ele.toUpperCase());
          });
      }

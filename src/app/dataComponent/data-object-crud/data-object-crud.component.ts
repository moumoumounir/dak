...
export class DataObjectCrudComponent implements OnInit {
    ...
    async  ngOnInit() {
      ...
      let paramString='colName=Ref_Object&colValue='+this.echangeData['Ref_Object']+'&sheet=DataAttributes'
      console.log(' paramString ',paramString)
      let o={'Ref_Object':this.echangeData['Ref_Object']}
      //this.usuariosService.getDataByCol(paramString).subscribe(
      this.usuariosService.getDataByCols('DataAttributes',o).subscribe(
        data =>{
          this.listData.data = data;
         console.log(this.echangeData['Ref_Object'],' data attributes ',JSON.stringify(data))
        }
      )}else  {
        this.listData.data = []; 
        this.echangeData=[]

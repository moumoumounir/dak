...
@Component({
  selector: 'app-attribute-crud',
  templateUrl: './attribute-crud.component.html',
  styleUrls: ['./attribute-crud.component.css']
})


export class attributeCrudComponent implements OnInit {
...
//this.usuariosService.updateUserRequestValidation(this.crudData).subscribe(resultat => {
  ...
  pickerEvent(event:any){
    ...
    uploadFile(file:File){
      ...
      if ( uuser !== null )uploadData.append('user',uuser);
